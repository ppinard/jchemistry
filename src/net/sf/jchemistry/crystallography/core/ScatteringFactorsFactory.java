 ...
 */
public final class ScatteringFactorsFactory {
    ...
    private static class ElectronMottBetheSF implements ScatteringFactors,
        ...
        public String getCitation() {
            return "International Tables for Crystallography (Volume C), Equation 4.3.1.14, Tables 6.1.1.4 and 6.1.1.5";
        }
    ...
    private static class ElectronSF extends SFTabulated {
        ...
        @Override
        public String getCitation() {
            return "International Tables for Crystallography (Volume C), Tables 4.3.2.2 and 4.3.2.3";
        }
    ...
    private static class XRaySF extends SFTabulated {
        ...
        @Override
        public String getCitation() {
            return "International Tables for Crystallography (Volume C), Tables 6.1.1.4 and 6.1.1.5";
        }
    ...
    /**
     * Returns the possible scattering factors.
     * 
     * @return array of possible scattering factors
     */
    public static ScatteringFactors[] values() {
        return new ScatteringFactors[] { XRAY_TABULATED, ELECTRON_TABULATED,
                ELECTRON_MOTT_BETHE };
    }
     ...
     */
    private ScatteringFactorsFactory() {
    }
