...
public class CalculationsTest {
    ...
    private ScatteringFactors scatter;
    ...
    public void setUp() throws Exception {
        ...
        atom1 = new AtomSite(Element.O, new Vector3D(0.4141, 0.2681, 0.1188));
        atom2 = new AtomSite(Element.Si, new Vector3D(0.4699, 0.0, 0.0));
        atom3 = new AtomSite(Element.Si, new Vector3D(0.5301, 0.5301, 0.3333));
        ...
        atom4 = new AtomSite(Element.O, new Vector3D(0.3419, 0.3587, 0.1333));
        atom5 = new AtomSite(Element.Si, new Vector3D(0.5041, 0.3204, 0.1099));
        atom6 = new AtomSite(Element.Al, new Vector3D(0.1852, 0.3775, 0.1816));
        ...
        // Scattering factors
        scatter = ScatteringFactorsFactory.XRAY_TABULATED;

        // Atom sites
        atomsfcc = AtomSitesFactory.atomSitesFCC(Element.Si);
        atomsbcc = AtomSitesFactory.atomSitesBCC(Element.Si);
        atomshcp = AtomSitesFactory.atomSitesHCP(Element.Si);
    }
    ...
    public void testEquivalentPositions() {
        ...
        atoms.add(new AtomSite(Element.Si, new Vector3D(0.0, 0.0, 0.0)));
        AtomSites results =
    ...
    public void testInterplanarAngleCubic() {
        for (Vector3D plane1 : planes)
            for (Vector3D plane2 : planes) {
                ...
                double expected = MathUtils.acos(cosangle);
    ...
    public void testInterplanarAngleHexagonal() {
        for (Vector3D plane1 : planes)
            for (Vector3D plane2 : planes) {
                ...
                double a = hexagonal.getA();
                double c = hexagonal.getC();
    ...
    public void testInterplanarAngleMonoclinic() {
        for (Vector3D plane1 : planes)
            for (Vector3D plane2 : planes) {
                ...
                double a = monoclinic.getA();
                double b = monoclinic.getB();
                double c = monoclinic.getC();
                double beta = monoclinic.getBeta();
    ...
    public void testInterplanarAngleOrthorhombic() {
        for (Vector3D plane1 : planes)
            for (Vector3D plane2 : planes) {
                ...
                double a = orthorhombic.getA();
                double b = orthorhombic.getB();
                double c = orthorhombic.getC();
    ...
    public void testInterplanarAngleTetragonal() {
        for (Vector3D plane1 : planes)
            for (Vector3D plane2 : planes) {
                ...
                double a = tetragonal.getA();
                double c = tetragonal.getC();
    ...
    public void testInterplanarAngleTriclinic() {
        for (Vector3D plane1 : planes)
            for (Vector3D plane2 : planes) {
                ...
                double a = triclinic.getA();
                double b = triclinic.getB();
                double c = triclinic.getC();
                double alpha = triclinic.getAlpha();
                double beta = triclinic.getBeta();
                double gamma = triclinic.getGamma();
    ...
    public void testInterplanarAngleTrigonal() {
        for (Vector3D plane1 : planes)
            for (Vector3D plane2 : planes) {
                ...
                double a = trigonal.getA();
                double alpha = trigonal.getAlpha();
    ...
    public void testZoneAxis() {
        ...
        assertEquals(expectedZone.getX(), zone.getX(), 1e-3);
        assertEquals(expectedZone.getY(), zone.getY(), 1e-3);
        assertEquals(expectedZone.getZ(), zone.getZ(), 1e-3);
    ...
    public void testPlaneNormal() {
        ...
        Vector3D actual = Calculations.planeNormal(n, unitCell);
